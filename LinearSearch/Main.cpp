...
// Линейный поиск первого вхождения элемента key в массив arr начиная с позиции degin
template <typename T>
...
// Линейный поиск последнего вхождения элемента key в массив arr начиная с позиции degin
template <typename T>
